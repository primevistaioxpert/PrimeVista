...
const Header1 = ({ style = "", fluid }) => {
    ...
    return (
        <>
            ...
            <div className={`right-sidebar-menu ${state.isRightSidebar ? "show-right-menu" : "false"
                }`}>

                <div className="sidebar-logo-area d-flex justify-content-between align-items-center">
                    <div className="sidebar-logo-wrap">
                        <Link href="/"><img alt="image" src="/assets/img/pdmslogo140.png" /></Link>
                    </div>
                ...
                <div className="sidebar-content-wrap">
                    <div className="title-area">
                        ...
                        <h2>Connect With Prime Vista</h2>
                    ...
                    <ul className="address-area">
                        <li className="single-address">
                            <span>SURREY</span>
                            <p>101 Interprice Way, BC, Canada</p>
                        </li>
                        <li className="single-address">
                            <span>BURNABY</span>
                            <p>101 Interprice Way, BC, Canada</p>
                ...
                <div className="sidebar-bottom-area">
                    <p>Copyright 2025 <Link href="/">Prime Vista</Link> | Design By <a href="https://www.ioxpert.com/">Ioxpert</a></p>
                </div>
            </div>
            <header className={`header-area style-1 ${style} ${state.scrollY > 20 ? "sticky" : ""}`}>
                <div className={`${fluid} d-flex flex-nowrap align-items-center justify-content-between`}>
                    <div className="header-logo">
                        <Link href={"/"}><img alt="image" className="img-fluid" src="/assets/img/pdmslogo.png" /></Link>
                    </div>
                    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                        <div className="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
                            <div className="mobile-logo-wrap">
                                <Link href="/"><img alt="image" src="/assets/img/pdmslogo.png" /></Link>
                            </div>
